...
const KEYS_TO_TEST_PATH = path.resolve(__dirname, "../config/keysToTest.json");
const JSON_REF = path.resolve(__dirname, "../data/reference-json");
const JSON_GEN = path.resolve(__dirname, "../data/generated-json");
const JSON_REF_SERIE = "gen-3";
const JSON_GEN_SERIE = "gen-4";
...
// wczytanie ingo które klucze porównać
